...
Fleet-canonical table (`clicore/cierrors.ExitCodeFor`). **Changed:** auth was `3`, now `2`; not-found was folded into `1`, now `4`; CLI usage errors surface via cobra (exit 1).
